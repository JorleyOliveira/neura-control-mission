...
# Default key: ~/.ssh/lightsail-us-east-1.pem (copy it there from Downloads first:
#   cp ~/Downloads/LightsailDefaultKey-us-east-1.pem ~/.ssh/lightsail-us-east-1.pem
#   chmod 600 ~/.ssh/lightsail-us-east-1.pem )
set -euo pipefail
# /Users/jorley/.ssh/LightsailDefaultKey-us-east-1.pem
KEY="${1:-$HOME/.ssh/lightsail-us-east-1.pem}"
SERVER="ubuntu@32.197.43.221"
...
echo "== 3/3 done =="
echo "UI :  http://32.197.43.221:8080"
echo "API:  http://32.197.43.221:8000/health"
